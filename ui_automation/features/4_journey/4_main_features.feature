...
Feature: Main features with Pathway
  ...
  Scenario: Verify post like feature Journey
  ...
  Scenario: Verify remove like feature Journey on Me - Content
    Given Sign in as "existing user"
    And Verify the login has been "successful"
  ...
  Scenario: Verify leave comment feature for Journey
    Given Sign in as "existing user"
    And Verify the login has been "successful"
    Then Create "Journey" with "Text" card
    And Verify that a card has been created
    Then "Leave" a comment for "Journey"

  Scenario: Verify delete comment feature Journey
    Given Sign in as "existing user"
    And Verify the login has been "successful"
    And Navigate to "ME" page "Content" tab
    Then "Delete" a comment for "Journey"
    And "Delete" a card from your content
  ...
  """
  @BUG
  Scenario: Verify mark as complete feature for Journey
    Given Sign in as "existing user"
    And Verify the login has been "successful"
    Then Create "Journey" with "Text" card
    And Verify that a card has been created
    Then Verify that possible to completed "Journey"
    And "Delete" a card from your content

  Scenario: Verify user has access to manage content -- Journey "Post to Channel"
    Given Sign in as "existing user"
    And Verify the login has been "successful"
    Then Create "Journey" with "Text" card
    And Verify that a card has been created
  ...
  Scenario: Verify that user able to use option Assign to Me card for Journey
    Given Sign in as "existing user"
    And Verify the login has been "successful"
    Then Create "Journey" with "Text" card
    And Verify that a card has been created
